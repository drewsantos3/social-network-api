...
module.exports = {
  getUsers(req, res) {
    User.find()
    // populate thoughts and friends with model data
      .populate("thoughts")
      .populate("friends")
...
//   update database with new user data with $set operator
  updateUser(req, res) {
  ...
  deleteUser(req, res) {
    ...
    // delete all thoughts associated with user from thought collection
      .then((user) => {
